...
app.use((req, res, next) => {
    Logger.info(`Pincode Service -- X-Request-Id: ${req.headers['x-request-id']}\n`);
    Logger.info(`Pincode Service -- X-Tenant-Id: ${req.headers['x-tenant-id']}\n`);
...
//===== START SERVER
app.listen(PORT, () => {
    Logger.info(`Pincode Service is listening on port ${PORT}`);
    console.log(`Pincode Service is listening on port ${PORT}`);
});
